...
//        let textFrame = viewModel.isEditing ? CGRect(origin: viewModel.textFrame.origin,
//                                                     size: CGSize(width: viewModel.textFrame.width - viewModel.checkBoxWidth,
//                                                                  height: viewModel.textFrame.height))
//                                            : viewModel.textFrame
